                ...
                <div class="8u skel-cell-important">
                    ...
                    <section>
                        <form action="results.php" method="post" enctype="multipart/form-data">
                            <textarea name="tripledestext" placeholder="Enter the plaintext here to encrypt it" value=""></textarea>
                            <?php
							...
							?>
                            <br><br>
                            <input type="text" name="tripledeskey" placeholder="Enter key in number (0-25)" >
                            <br>
                            <input type="hidden" name="cipherName" value="TRIPLE DES">
                            <input type=submit>
                            <input type=reset>
                        </form>
                    </section>
                    ...
                    <section>
                        <form action="decryptresults.php" method="post" enctype="multipart/form-data">
                            <textarea name="tripledesEncryptedtext" placeholder="Enter the encrypted text here to decrypt it" value=""></textarea>
                            <?php
                            if(isset($_SESSION['userEmail'])){
                                echo "<b>OR &nbsp</b><input type=\"file\" name=\"CipherFile\" value=\"Upload File\"
								data-validation=\"mime size\" data-validation-allowing=\"txt\" data-validation-max-size=\"1024kb\"><b>(Supports only 'txt' File!)";
